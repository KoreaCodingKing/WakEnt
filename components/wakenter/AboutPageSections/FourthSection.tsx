    ...
    <section className={classes(className)} data-index={3}>
      <div className={styles.section_container}>
        <div className={styles.contents_wrapper}>
          <motion.div
            className={styles.infra_introduce}
            style={{
          ...
          >
            <div className={styles.image_wrapper}>
              <Image
                src={"/images/building/recording_room_mixer.png"}
                alt="믹서 기기"
                layout="fill"
              ></Image>
            </div>
            <div className={styles.title_wrapper}>
              ...
              <p className={styles.subtitle}>
                회사 스튜디오 내에 업계 최고급 오디오 장비를 구비하여 소비자에게
                최고의 경험을 선사하고자 노력하고 있습니다.
              </p>
            </div>
          </motion.div>
          <motion.div
            className={styles.crew_container}
            style={{
          ...
          >
            <div className={styles.image_wrapper}>
              <Image
                src={"/images/member/benzenpro.jpg"}
                alt="벤젠프로"
                layout="fill"
              ></Image>
            </div>
            <div className={styles.title_wrapper}>
              ...
              <p className={styles.subtitle}>
                각 분야 극한의 알잘딱 실력자들이 모인 스튜디오에서 원하는 것을
                모두 이룰 수 있습니다.
              </p>
            </div>
          </motion.div>
