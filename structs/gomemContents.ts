...
export const gomemContents: Record<GomemMemberID, GomemContents[]> = {
  SecretGirl: [
    ...
    {
      type: 'Songs',
      title: '저세계아이돌 - 이세돌 리와인드 (이세계아이돌 RE:WIND) | 왁타버스 VR챗(VRChat) MV',
      links: 'aZObIwRaEm4',
      date: '22.02.10'
    },
    {
    ...
    {
      type: 'Songs',
      title: '불협화음 (권민, 비밀소녀, 단답벌레) COVER - (AKMU, 머드더스튜던트)',
      links: 'pWiiZkgD1Nk',
      date: '21.12.16'
    },
    {
      type: 'Songs',
      title: 'IU (아이유) - Friday (금요일에 만나요) - 해루석 x 비밀소녀 "루비" cover',
      links: 'OBSCvhgRgSk',
      date: '21.10.16'
    },
    {
  ...
  MitsuneHaku: [
    ...
    {
      type: 'Songs',
      title: '【4K】 🍫미리 발렌타인데이: 드리밍 츄츄♥ [미츠네 하쿠x왁컬로이두 COVER] - (Dreamin Chuchu / どりーみんチュチュ)(MEGURINE LUKA)',
      links: 'tZtskWzmpXs',
      date: '22.02.11',
    },
    {
      type: 'Songs',
      title: '【불러보았다】 스타 나이트 스노우/ 하츠네미쿠 (Covered by 미츠네 하쿠)',
      links: 'uTVfPC6gfjs',
      date: '21.12.28',
    },
    {
    ...
    {
      type: 'Songs',
      title: '2021 수능 응원곡 QUEST (독고혜지x미츠네하쿠x비밀소녀) (원곡:クエスト - れるりり)',
      links: 'zbUc-rCuXsY',
      date: '21.11.14',
    },
    {
  ...
  HikiKing: [
    ...
    {
      type: 'Contents',
      title: '이세돌 리와인드 개같이 커버(이세계아이돌 RE:WIND)히키킹 - VR챗(REWIND)',
      links: 'y4TPkdQgEDE',
      date: '21.12.24'
    },
    {
    ...
    {
      type: 'Contents',
      title: '불협화음 - 망해버린,이세돌(이찬혁 파트)히키킹.cover - Mudd the student, AKMU (머드 더 스튜던트, 악뮤) 왁타버스 - VR챗 VRCHAT',
      links: 'DSERnRglRsE',
      date: '21.12.15'
    },
    {
  ...
  KimchiMandoo: [
    ...
    {
      type: 'Songs',
      title: '12월의로망스 - 유리상자 cover - 김치만두번영택사스가 x 단답벌레 "단김" (Chorus.부정형인간)',
      links: 'Nb2OSuSuw3w',
      date: '22.02.22'
    },
    {
  ...
  NegativePerson: [
    ...
    {
      type: 'Songs',
      title: '백예린 - 그건 아마 우리의 잘못은 아닐 거야 Cover by 부정형 인간 (Feat. 소피아) I [WF LIVE]',
      links: 'UVsHCOfHHc4',
      date: '21.11.09'
    },
  ],
  ...
  Freeter: [
    ...
    {
      type: 'Contents',
      title: '이세계아이돌 (ISEGYE IDOL) 비챤_VIichan 취기를 빌려(Slightly Tipsy) Cover Reaction',
      links: 'G98GU8zevTw',
      date: '22.03.17'
    },
  ],
